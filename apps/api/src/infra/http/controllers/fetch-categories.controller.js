...
const category_presenter_1 = require("../presenters/category-presenter");
...
let FetchCategoriesController = class FetchCategoriesController {
    fetchCategories;
    constructor(fetchCategories) {
    ...
    async handle(page) {
        ...
        return {
            categories: categories.map(category_presenter_1.CategoryPresenter.toHTTP),
            totalPages,
        };
    }
};
...
], FetchCategoriesController.prototype, "handle", null);
exports.FetchCategoriesController = FetchCategoriesController = __decorate([
    (0, swagger_1.ApiTags)('Category'),
    (0, common_1.Controller)('/categories'),
    __metadata("design:paramtypes", [fetch_categories_1.FetchCategoriesUseCase])
], FetchCategoriesController);
//# sourceMappingURL=fetch-categories.controller.js.map